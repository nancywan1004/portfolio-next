...
const ProjectCard = (props) => {
    return (
        <div class="overflow-hidden shadow-lg rounded-lg h-auto w-80 md:w-80 cursor-pointer m-auto p-4 bg-indigo-50 transition duration-500 ease-in-out transform hover:translate-y-5 hover:shadow-2xl dark:bg-gray-900">
                    ...
                    <div class="flex flex-wrap justify-starts items-center mt-4 border-t-2 pt-5">
                        {
                            ...
                            <div class="text-xs mr-2 py-1.5 px-4 text-gray-600 bg-blue-200 rounded-2xl dark:text-white" key={idx}>
                                {item}
                            </div>
                            ))
                        }
