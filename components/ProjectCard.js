...
const ProjectCard = (props) => {
    return (
        <div class="overflow-hidden shadow-lg rounded-lg h-auto w-80 md:w-80 cursor-pointer m-auto p-4 bg-amber-600 transition duration-500 ease-in-out transform hover:shadow-2xl dark:bg-gray-500">
            <a class="w-full block max-h-full">
                ...
                <div class="w-full">
                    <p class="text-gray-800 h-8 dark:text-white text-xl font-medium mb-2">
                        {props.title}
                    </p>
                    ...
                    <div class="collapse-title text-gray-600 dark:text-white text-md font-medium">
                    ...
                    <div class="flex flex-wrap justify-starts items-center mt-4 border-t-2 pt-5">
                        {
                            ...
                            <div class="text-xs mr-2 py-1.5 px-4 text-gray-600 bg-yellow-100 rounded-2xl" key={idx}>
                                {item}
                            </div>
                            ))
                        }
