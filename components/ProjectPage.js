...
const PrevButton = ({ prevSlug }) => {
    if (!prevSlug) {
        return (
            <button type="button" class="text-black rounded-r-md py-2 hover:border-l border-gray-300 disabled:text-gray-300 hover:text-black px-3" disabled={!prevSlug}>
    ...
    return (
            <button type="button" class="text-black rounded-l-md hover:border-r border-gray-300 py-2 disabled:text-gray-300 hover:text-black px-3">
...
const NextButton = ({ nextSlug }) => {
    if (!nextSlug) {
        return (
            <button type="button" class="text-black rounded-r-md py-2 hover:border-l border-gray-300 disabled:text-gray-300 hover:text-black px-3" disabled={!nextSlug}>
            <div class="flex flex-row align-middle">
    ...
    return (
        <button type="button" class="text-black rounded-r-md py-2 hover:border-l border-gray-300 disabled:text-gray-300 hover:text-black px-3">
